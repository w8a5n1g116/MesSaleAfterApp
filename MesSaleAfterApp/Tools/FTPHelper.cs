...
namespace ManagementProject
{
    public class FTPHelper
    {
        ...
        /// Ftp服务器ip
        /// </summary>
        public static string FtpServerIP = "192.168.0.50";
        /// <summary>
        /// Ftp 指定用户名
        /// </summary>
        ...
        public static MemoryStream FtpDownloadMemoryStream(string remoteFileName, bool ifCredential, long size)
        {
            FtpWebRequest reqFTP, ftpsize;
            Stream ftpStream = null;
            FtpWebResponse response = null;
        ...
        /// <param name="updateProgress">报告进度的处理(第一个参数：总大小，第二个参数：当前进度)</param>
        /// <returns></returns>       
        public static string FtpUploadBroken(string localFullPath, string remoteFilepath,string newFileName, Action<int, int> updateProgress = null)
        {
